        ...
        <div class="flex flex-wrap mt-6 -mx-3">
                ...
                <div class="flex flex-wrap -mx-3">
                  <div class="max-w-full px-3 lg:w-1/2 lg:flex-none">
                    <div class="flex flex-col h-full">
                      <p class="pt-2 mb-1 font-semibold">Non-Communicable Disease</p>
                      <h5 class="font-bold">Health and Wellness Monitoring</h5>
                      <p class="mb-12">Will provide the DOH CVCHD staff information and data of their laboratory test and others training examinations provided by the NCDS office staff and VSMMC wellness clinic. In addition, it will also provide reminded for regular staff to avail of their anual health check-up at the VSMMC Health Wellness Clinic</p>
                  ...
                  <div class="max-w-full px-3 mt-12 ml-auto text-center lg:mt-0 lg:w-5/12 lg:flex-none">
                    <div class="h-full bg-gradient-to-tl from-purple-700 to-pink-500 rounded-xl">
                      <div class="relative flex items-center justify-center h-full">
                        <img class="relative z-20 w-full p-4" :src="laboratory_transparent" alt="laboratory" />
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="w-full max-w-full px-3 lg:w-5/12 lg:flex-none">
            <div class="border-black/12.5 shadow-soft-xl relative flex h-full min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border p-4">
              <div class="relative h-full overflow-hidden bg-cover rounded-xl" :style="{ 'background-image': `url(${curved})` }">
          ...
          <div class="w-full max-w-full px-3 mt-0 mb-6 lg:mb-0 lg:w-5/12 lg:flex-none">
            <div class="border-black/12.5 shadow-soft-xl relative z-20 flex min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border">
              <div class="flex-auto p-4">
                ...
                <h6 class="mt-6 mb-0 ml-2">Laboratory Employee</h6>
                  ...
                  <div class="flex flex-wrap mt-0 -mx-3">
                    ...
                    <!-- <div class="flex-none w-1/3 max-w-full py-4 pl-0 pr-3 mt-0">
                      <div class="flex mb-2">
                        ...
                        <p class="mt-1 mb-0 font-semibold leading-tight text-xs">Number of Employees UnAvail</p>
                      </div>
          ...
          <div class="w-full max-w-full px-3 mt-0 lg:w-7/12 lg:flex-none">
            <div class="border-black/12.5 shadow-soft-xl relative z-20 flex min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border">
              <div class="border-black/12.5 mb-0 rounded-t-2xl border-b-0 border-solid bg-white p-6 pb-0">
                <h6>Laboratory overview</h6>
                <p class="leading-normal text-sm">
                  <i class="fa fa-arrow-up text-lime-500"></i>
                  <span class="font-semibold">4% more</span> in {{ moment().format('YYYY') }}
                </p>
              </div>
              <div class="flex-auto p-4">
                <div>
