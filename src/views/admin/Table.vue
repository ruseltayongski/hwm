<script setup lang="ts">
    ...
    import LogoInvision from "@/style/assets/img/illustrations/rocket-white.png"
    import LogoJira from "@/style/assets/img/illustrations/rocket-white.png"
    import LogoSlack from "@/style/assets/img/small-logos/logo-xd.svg"
    import LogoWebdev from "@/style/assets/img/team-1.jpg"
    import LogoXd from "@/style/assets/img/small-logos/logo-atlassian.svg"
                    ...
                    <tbody>
                      <tr>
                        <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                          <div class="flex px-2">
                            <div>
                              <img :src="logo_spotify" class="inline-flex items-center justify-center mr-2 text-white transition-all duration-200 rounded-full ease-soft-in-out text-sm h-9 w-9" alt="spotify" />
                            </div>
                            <div class="my-auto">
                      ...
                      <tr>
                        <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                          <div class="flex px-2">
                            <div>
                              <img :src="logo_invision" class="inline-flex items-center justify-center mr-2 text-white transition-all duration-200 rounded-full ease-soft-in-out text-sm h-9 w-9" alt="invision" />
                            </div>
                            <div class="my-auto">
                      ...
                      <tr>
                        <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                          <div class="flex px-2">
                            <div>
                              <img :src="logo_jira" class="inline-flex items-center justify-center mr-2 text-white transition-all duration-200 rounded-full ease-soft-in-out text-sm h-9 w-9" alt="jira" />
                            </div>
                            <div class="my-auto">
                      ...
                      <tr>
                        <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                          <div class="flex px-2">
                            <div>
                              <img :src="logo_slack" class="inline-flex items-center justify-center mr-2 text-white transition-all duration-200 rounded-full ease-soft-in-out text-sm h-9 w-9" alt="slack" />
                            </div>
                            <div class="my-auto">
                      ...
                      <tr>
                        <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                          <div class="flex px-2">
                            <div>
                              <img :src="logo_webdev" class="inline-flex items-center justify-center mr-2 text-white transition-all duration-200 rounded-full ease-soft-in-out text-sm h-9 w-9" alt="webdev" />
                            </div>
                            <div class="my-auto">
                      ...
                      <tr>
                        <td class="p-2 align-middle bg-transparent border-b-0 whitespace-nowrap shadow-transparent">
                          <div class="flex px-2">
                            <div>
                              <img :src="logo_xd" class="inline-flex items-center justify-center mr-2 text-white transition-all duration-200 rounded-full ease-soft-in-out text-sm h-9 w-9" alt="xd" />
                            </div>
                            <div class="my-auto">
