<script setup lang="ts">
    ...
    import WhiteCurved from "@/style/assets/img/curved-images/white-curved.jpeg";

    const logo_ct = ref(LogoCt);
    const white_curved = ref(WhiteCurved);
</script>
<template>
    <!-- sidenav  -->
      ...
      <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
        <ul class="flex flex-col pl-0 mb-0">
          <li class="mt-0.5 w-full">
            <router-link to="/admin" class="py-2.7 shadow-soft-xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 font-semibold text-slate-700 transition-colors">
          ...
          <li class="mt-0.5 w-full">
            <router-link to="/table" class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors">
